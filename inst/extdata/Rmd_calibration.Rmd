...
knitr::kable(st1, digits=c(0,3,3,3,3,3,3,0), caption = "Table 3. Performance statistics for models selected based on the user's pre-defined critera.")
```
...
Following the statistics of performance for all candidate models (a sample if more than 500 models) are presented. See file calibration_results.csv for the complete list.
...
knitr::kable(st4, digits=c(0,3,3,3,3,3,3,0), caption = "Table 4. Performance statistics for candidate models.")
```
