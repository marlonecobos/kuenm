...
#'
#' A dataset containing occurrence recods of the Turkey Tick (*Amblyomma americanum*)
#' in North America, used to test candidate ecological niche models during calibration.
#'
