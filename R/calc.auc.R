...
#'
#' @description calc.auc calculates the area under the curve using a threshold (E) value.
#' This function is designed to be used specifically in the \code{\link{ku.enm.proc}} function.
#'
#' @param xytable a XY coordinates table prepared with the \code{\link{g.xy.tab}} function.
