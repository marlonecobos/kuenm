...
```{r Fig.1, echo=FALSE, message=FALSE, warning=FALSE, fig.height=4, fig.width=6, fig.cap="Figure 1. Directory structure and data for starting and when finished the processes using the ku.enm R package. Background colors represent necessary data before starting the analyses (blue) and data generated after: using the start function (yellow), creating candidate models (lighter green), evaluating candidate models (purple), preparing projection layers (light orange), generating final models and its projections (light grey), evaluating final models with independent data (brown), and analyzing extrapolation risks in projection areas or scenarios (darker green).", cache=TRUE}
